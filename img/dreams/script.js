document.addEventListener('DOMContentLoaded', () => {
    ...
    const photoData = {
        people: [
            { src: 'CAPTURE.png', title: 'People 1', desc: '' },
            { src: 'CAPTURE.png', title: 'People 2', desc: '' },
            { src: 'CAPTURE.png', title: 'People 3', desc: '' }
        ],
        urbex: [
            { src: 'CAPTURE.png', title: 'Urbex & Places 1', desc: '' },
            { src: 'CAPTURE.png', title: 'Urbex & Places 2', desc: '' },
            { src: 'CAPTURE.png', title: 'Urbex & Places 3', desc: '' }
        ],
        dreams: [
            { src: 'img/dreams/IMG_0755.jpeg', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1089.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1109.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1110.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1117.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1122.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1125.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1129.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1136.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1137.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1141.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1148.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1169.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1175.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1181.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1188.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1190.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1201.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1202.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1205.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1207.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1208.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1212.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1217.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1220.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1223.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_1227.JPG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_6002.PNG', title: 'Dreams', desc: '' },
            { src: 'img/dreams/IMG_7004.jpg', title: 'Dreams', desc: '' }
        ]
    };

    let currentPhotoSeries = 'people';
    ...
    const updatePhotoGallery = (index) => {
        if(!photoImg) return;

        const series = photoData[currentPhotoSeries];
        ...
        setTimeout(() => {
            ...
            photoCounter.textContent = `0${index + 1} / 0${series.length}`;
    ...
    if(photoNext && photoPrev) {
        photoNext.addEventListener('click', () => {
            const series = photoData[currentPhotoSeries];
            currentPhotoIndex = (currentPhotoIndex + 1) % series.length;
            updatePhotoGallery(currentPhotoIndex);
        });

        photoPrev.addEventListener('click', () => {
            const series = photoData[currentPhotoSeries];
            currentPhotoIndex = (currentPhotoIndex - 1 + series.length) % series.length;
            updatePhotoGallery(currentPhotoIndex);
        });
    }
    ...
    photoTabs.forEach(tab => {
        tab.addEventListener('click', () => {
            ...
            currentPhotoSeries = tab.getAttribute('data-series');
            currentPhotoIndex = 0;
            updatePhotoGallery(currentPhotoIndex);
        });
    });
